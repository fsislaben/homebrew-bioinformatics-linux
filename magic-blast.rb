class MagicBlast < Formula
  ...
  homepage "https://blast.ncbi.nlm.nih.gov/Blast.cgi?CMD=Web&PAGE_TYPE=BlastNews#1"
  # tag "bioinformatics"

  version "1.1.0"
  if OS.mac?
    url "https://ftp.ncbi.nlm.nih.gov/blast/executables/magicblast/#{version}/ncbi-magicblast-#{version}-x64-macosx.tar.gz"
    sha256 "f962174327841a5f0528a84270b3efb96d7fcdaecba09f3349056836f31ee636"
  elsif OS.linux?
    url "https://ftp.ncbi.nlm.nih.gov/blast/executables/magicblast/#{version}/ncbi-magicblast-#{version}-x64-linux.tar.gz"
